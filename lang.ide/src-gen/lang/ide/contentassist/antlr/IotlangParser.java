	...
	protected String getRuleName(AbstractElement element) {
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				...
				{
					put(grammarAccess.getIoTLangModelAccess().getAlternatives_1(), "rule__IoTLangModel__Alternatives_1");
					...
					put(grammarAccess.getChannelingAccess().getDirectionAlternatives_5_0(), "rule__Channeling__DirectionAlternatives_5_0");
					put(grammarAccess.getIoTLangModelAccess().getGroup(), "rule__IoTLangModel__Group__0");
					put(grammarAccess.getIoTLangModelAccess().getGroup_0(), "rule__IoTLangModel__Group_0__0");
					put(grammarAccess.getPlatformAnnotationAccess().getGroup(), "rule__PlatformAnnotation__Group__0");
					put(grammarAccess.getNamedElementAccess().getGroup_15(), "rule__NamedElement__Group_15__0");
					put(grammarAccess.getAnnotatedElementAccess().getGroup_15(), "rule__AnnotatedElement__Group_15__0");
					...
					put(grammarAccess.getBusAccess().getGroup(), "rule__Bus__Group__0");
					...
					put(grammarAccess.getInstanceGatewayAccess().getGroup(), "rule__InstanceGateway__Group__0");
					...
					put(grammarAccess.getChannelingAccess().getGroup(), "rule__Channeling__Group__0");
					put(grammarAccess.getChannelingAccess().getGroup_11(), "rule__Channeling__Group_11__0");
					put(grammarAccess.getIoTLangModelAccess().getImportURIAssignment_0_1(), "rule__IoTLangModel__ImportURIAssignment_0_1");
					put(grammarAccess.getIoTLangModelAccess().getTypesAssignment_1_0(), "rule__IoTLangModel__TypesAssignment_1_0");
					put(grammarAccess.getIoTLangModelAccess().getProtocolsAssignment_1_1(), "rule__IoTLangModel__ProtocolsAssignment_1_1");
					put(grammarAccess.getIoTLangModelAccess().getConfigsAssignment_1_2(), "rule__IoTLangModel__ConfigsAssignment_1_2");
					...
					put(grammarAccess.getNamedElementAccess().getNameAssignment_15_1(), "rule__NamedElement__NameAssignment_15_1");
					put(grammarAccess.getAnnotatedElementAccess().getAnnotationsAssignment_15_1(), "rule__AnnotatedElement__AnnotationsAssignment_15_1");
					...
					put(grammarAccess.getGatewayAccess().getNameAssignment_1(), "rule__Gateway__NameAssignment_1");
					put(grammarAccess.getGatewayAccess().getAnnotationsAssignment_2(), "rule__Gateway__AnnotationsAssignment_2");
					put(grammarAccess.getGatewayAccess().getBusesAssignment_4(), "rule__Gateway__BusesAssignment_4");
					put(grammarAccess.getBusAccess().getNameAssignment_1(), "rule__Bus__NameAssignment_1");
					put(grammarAccess.getBusAccess().getChannelsAssignment_3(), "rule__Bus__ChannelsAssignment_3");
					put(grammarAccess.getChannelAccess().getNameAssignment_1(), "rule__Channel__NameAssignment_1");
					put(grammarAccess.getChannelAccess().getChannelIdAssignment_3(), "rule__Channel__ChannelIdAssignment_3");
					...
					put(grammarAccess.getConfigurationAccess().getDomainAssignment_4_0(), "rule__Configuration__DomainAssignment_4_0");
					put(grammarAccess.getConfigurationAccess().getChannelingsAssignment_4_1(), "rule__Configuration__ChannelingsAssignment_4_1");
					put(grammarAccess.getConfigurationAccess().getInstancegatewaysAssignment_4_2(), "rule__Configuration__InstancegatewaysAssignment_4_2");
					put(grammarAccess.getConfigurationAccess().getInstancesAssignment_4_3(), "rule__Configuration__InstancesAssignment_4_3");
					put(grammarAccess.getConfigurationAccess().getConnectorsAssignment_4_4(), "rule__Configuration__ConnectorsAssignment_4_4");
					put(grammarAccess.getConfigurationAccess().getPropassignsAssignment_4_5(), "rule__Configuration__PropassignsAssignment_4_5");
					...
					put(grammarAccess.getInstanceGatewayAccess().getNameAssignment_1(), "rule__InstanceGateway__NameAssignment_1");
					put(grammarAccess.getInstanceGatewayAccess().getTypeGateAssignment_3(), "rule__InstanceGateway__TypeGateAssignment_3");
					put(grammarAccess.getInstanceGatewayAccess().getAnnotationsAssignment_4(), "rule__InstanceGateway__AnnotationsAssignment_4");
					...
					put(grammarAccess.getChannelingAccess().getNameAssignment_1(), "rule__Channeling__NameAssignment_1");
					put(grammarAccess.getChannelingAccess().getThinginstAssignment_2(), "rule__Channeling__ThinginstAssignment_2");
					put(grammarAccess.getChannelingAccess().getPortAssignment_4(), "rule__Channeling__PortAssignment_4");
					put(grammarAccess.getChannelingAccess().getDirectionAssignment_5(), "rule__Channeling__DirectionAssignment_5");
					put(grammarAccess.getChannelingAccess().getSrvAssignment_6(), "rule__Channeling__SrvAssignment_6");
					put(grammarAccess.getChannelingAccess().getBusesAssignment_8(), "rule__Channeling__BusesAssignment_8");
					put(grammarAccess.getChannelingAccess().getChannelsAssignment_10(), "rule__Channeling__ChannelsAssignment_10");
					put(grammarAccess.getChannelingAccess().getChannelsAssignment_11_1(), "rule__Channeling__ChannelsAssignment_11_1");
					put(grammarAccess.getChannelingAccess().getAnnotationsAssignment_13(), "rule__Channeling__AnnotationsAssignment_13");
				}
			};
		}
