		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getInstancePubSubAccess().getGroup(), "rule__InstancePubSub__Group__0");
					put(grammarAccess.getInstancePubSubAccess().getGroup_2(), "rule__InstancePubSub__Group_2__0");
					put(grammarAccess.getInstancePtPAccess().getGroup(), "rule__InstancePtP__Group__0");
					...
					put(grammarAccess.getChannelAccess().getPubSubAssignment_0(), "rule__Channel__PubSubAssignment_0");
					put(grammarAccess.getChannelAccess().getPointToPointAssignment_1(), "rule__Channel__PointToPointAssignment_1");
					...
					put(grammarAccess.getInstancePubSubAccess().getNameAssignment_1(), "rule__InstancePubSub__NameAssignment_1");
					put(grammarAccess.getInstancePubSubAccess().getNumberAssignment_2_1(), "rule__InstancePubSub__NumberAssignment_2_1");
					put(grammarAccess.getInstancePubSubAccess().getTypeChannelAssignment_4(), "rule__InstancePubSub__TypeChannelAssignment_4");
					put(grammarAccess.getInstancePubSubAccess().getOverProtocolAssignment_6(), "rule__InstancePubSub__OverProtocolAssignment_6");
					put(grammarAccess.getInstancePubSubAccess().getAnnotationsAssignment_7(), "rule__InstancePubSub__AnnotationsAssignment_7");
					put(grammarAccess.getInstancePtPAccess().getNameAssignment_1(), "rule__InstancePtP__NameAssignment_1");
					put(grammarAccess.getInstancePtPAccess().getNumberAssignment_2_1(), "rule__InstancePtP__NumberAssignment_2_1");
					put(grammarAccess.getInstancePtPAccess().getTypeChannelAssignment_4(), "rule__InstancePtP__TypeChannelAssignment_4");
					put(grammarAccess.getInstancePtPAccess().getOverProtocolAssignment_6(), "rule__InstancePtP__OverProtocolAssignment_6");
					put(grammarAccess.getInstancePtPAccess().getAnnotationsAssignment_7(), "rule__InstancePtP__AnnotationsAssignment_7");
					put(grammarAccess.getInstanceChannelAccess().getInstancesPubSubAssignment_0(), "rule__InstanceChannel__InstancesPubSubAssignment_0");
					put(grammarAccess.getInstanceChannelAccess().getInstancesPtpAssignment_1(), "rule__InstanceChannel__InstancesPtpAssignment_1");
					...
					put(grammarAccess.getBindAccess().getPubSubInstanceAssignment_4(), "rule__Bind__PubSubInstanceAssignment_4");
