...
@after {
	...
	(
		...
		{
			$current = $this_Gateway_4.current;
			afterParserOrEnumRuleCall();
		}
	)
;
...
@after {
	...
	(
		...
		(
			(
				lv_channelId_3_0=RULE_STRING_LIT
				{
...
entryRuleInstanceGateway returns [EObject current=null]:
	{ newCompositeNode(grammarAccess.getInstanceGatewayRule()); }
	iv_ruleInstanceGateway=ruleInstanceGateway
	{ $current=$iv_ruleInstanceGateway.current; }
	EOF;

// Rule InstanceGateway
ruleInstanceGateway returns [EObject current=null]
@init {
	enterRule();
}
@after {
...
entryRuleChanneling returns [EObject current=null]:
	{ newCompositeNode(grammarAccess.getChannelingRule()); }
	iv_ruleChanneling=ruleChanneling
	{ $current=$iv_ruleChanneling.current; }
	EOF;

// Rule Channeling
ruleChanneling returns [EObject current=null]
@init {
	enterRule();
}
@after {
