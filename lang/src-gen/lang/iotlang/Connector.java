 ...
 * </p>
 * <ul>
 *   <li>{@link lang.iotlang.Connector#getCli <em>Cli</em>}</li>
 *   <li>{@link lang.iotlang.Connector#getRequired <em>Required</em>}</li>
 *   <li>{@link lang.iotlang.Connector#getSrv <em>Srv</em>}</li>
 *   <li>{@link lang.iotlang.Connector#getProvided <em>Provided</em>}</li>
 * </ul>
 *
 * @see lang.iotlang.IotlangPackage#getConnector()
 * @model
 * @generated
 */
public interface Connector extends AbstractConnector
{
   ...
   * @see #setCli(Instance)
   * @see lang.iotlang.IotlangPackage#getConnector_Cli()
   * @model
   * @generated
   */
  Instance getCli();
  ...
  /**
   * Sets the value of the '{@link lang.iotlang.Connector#getCli <em>Cli</em>}' reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see lang.iotlang.IotlangPackage#getConnector_Required()
   * @model
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link lang.iotlang.Connector#getRequired <em>Required</em>}' reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see #setSrv(Instance)
   * @see lang.iotlang.IotlangPackage#getConnector_Srv()
   * @model
   * @generated
   */
  Instance getSrv();
  ...
  /**
   * Sets the value of the '{@link lang.iotlang.Connector#getSrv <em>Srv</em>}' reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see lang.iotlang.IotlangPackage#getConnector_Provided()
   * @model
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link lang.iotlang.Connector#getProvided <em>Provided</em>}' reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
