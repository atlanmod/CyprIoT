 ...
 * </p>
 * <ul>
 *   <li>{@link lang.iotlang.impl.DecrementImpl#getVar <em>Var</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DecrementImpl extends ActionImpl implements Decrement
{
  ...
  {
    return IotlangPackage.Literals.DECREMENT;
  }
    ...
    if (var != null && var.eIsProxy())
    {
      ...
      if (var != oldVar)
      {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, IotlangPackage.DECREMENT__VAR, oldVar, var));
      }
    }
    return var;
  }
  ...
  public void setVar(Variable newVar)
  {
    ...
    var = newVar;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, IotlangPackage.DECREMENT__VAR, oldVar, var));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case IotlangPackage.DECREMENT__VAR:
