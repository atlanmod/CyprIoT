 ...
 * </p>
 * <ul>
 *   <li>{@link lang.iotlang.impl.PrintActionImpl#getMsg <em>Msg</em>}</li>
 * </ul>
 *
 * @generated
 */
public class PrintActionImpl extends ActionImpl implements PrintAction
{
  ...
  {
    return IotlangPackage.Literals.PRINT_ACTION;
  }
  ...
  public NotificationChain basicSetMsg(Expression newMsg, NotificationChain msgs)
  {
    ...
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, IotlangPackage.PRINT_ACTION__MSG, oldMsg, newMsg);
  ...
  public void setMsg(Expression newMsg)
  {
    if (newMsg != msg)
    {
      ...
      if (msg != null)
        msgs = ((InternalEObject)msg).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - IotlangPackage.PRINT_ACTION__MSG, null, msgs);
      if (newMsg != null)
        msgs = ((InternalEObject)newMsg).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - IotlangPackage.PRINT_ACTION__MSG, null, msgs);
      msgs = basicSetMsg(newMsg, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, IotlangPackage.PRINT_ACTION__MSG, newMsg, newMsg));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case IotlangPackage.PRINT_ACTION__MSG:
