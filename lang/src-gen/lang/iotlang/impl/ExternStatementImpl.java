 ...
 * </p>
 * <ul>
 *   <li>{@link lang.iotlang.impl.ExternStatementImpl#getStatement <em>Statement</em>}</li>
 *   <li>{@link lang.iotlang.impl.ExternStatementImpl#getSegments <em>Segments</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ExternStatementImpl extends ActionImpl implements ExternStatement
{
  ...
  {
    return IotlangPackage.Literals.EXTERN_STATEMENT;
  }
  ...
  public void setStatement(String newStatement)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, IotlangPackage.EXTERN_STATEMENT__STATEMENT, oldStatement, statement));
  }
  ...
  public EList<Expression> getSegments()
  {
    if (segments == null)
    {
      segments = new EObjectContainmentEList<Expression>(Expression.class, this, IotlangPackage.EXTERN_STATEMENT__SEGMENTS);
    }
    return segments;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case IotlangPackage.EXTERN_STATEMENT__SEGMENTS:
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case IotlangPackage.EXTERN_STATEMENT__STATEMENT:
        return getStatement();
      case IotlangPackage.EXTERN_STATEMENT__SEGMENTS:
        return getSegments();
    }
