 ...
 * </p>
 * <ul>
 *   <li>{@link lang.iotlang.impl.ErrorActionImpl#getMsg <em>Msg</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ErrorActionImpl extends ActionImpl implements ErrorAction
{
  ...
  {
    return IotlangPackage.Literals.ERROR_ACTION;
  }
  ...
  public NotificationChain basicSetMsg(Expression newMsg, NotificationChain msgs)
  {
    ...
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, IotlangPackage.ERROR_ACTION__MSG, oldMsg, newMsg);
  ...
  public void setMsg(Expression newMsg)
  {
    if (newMsg != msg)
    {
      ...
      if (msg != null)
        msgs = ((InternalEObject)msg).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - IotlangPackage.ERROR_ACTION__MSG, null, msgs);
      if (newMsg != null)
        msgs = ((InternalEObject)newMsg).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - IotlangPackage.ERROR_ACTION__MSG, null, msgs);
      msgs = basicSetMsg(newMsg, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, IotlangPackage.ERROR_ACTION__MSG, newMsg, newMsg));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case IotlangPackage.ERROR_ACTION__MSG:
