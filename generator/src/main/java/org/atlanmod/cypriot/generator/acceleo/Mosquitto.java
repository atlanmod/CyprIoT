...
/**
 * Entry point of the 'Mosquitto' generation module.
 *
 * @generated
 */
public class Mosquitto extends AbstractAcceleoGenerator {
    /**
     ...
     * @generated
     */
    public Mosquitto(URI modelURI, File targetFolder,
     ...
     * @generated
     */
    public Mosquitto(EObject model, File targetFolder,
            List<? extends Object> arguments) throws IOException {
    ...
    public static void main(String[] args) {
        try {
            if (args.length < 2) {
                ...
                Mosquitto generator = new Mosquitto(modelURI, folder, arguments);
