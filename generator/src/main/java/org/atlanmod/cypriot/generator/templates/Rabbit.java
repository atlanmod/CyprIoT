...
/**
 * Entry point of the 'Rabbit' generation module.
 *
 * @generated
 */
public class Rabbit extends AbstractAcceleoGenerator {
    /**
     * The name of the module.
     *
     * @generated
     */
    public static final String MODULE_FILE_NAME = "/org/atlanmod/cypriot/generator/templates/rabbit";
     ...
     * @generated
     */
    public Rabbit(URI modelURI, File targetFolder,
     ...
     * @generated
     */
    public Rabbit(EObject model, File targetFolder,
            List<? extends Object> arguments) throws IOException {
    ...
    public static void main(String[] args) {
        try {
            if (args.length < 2) {
                ...
                Rabbit generator = new Rabbit(modelURI, folder, arguments);
