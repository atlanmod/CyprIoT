...
/**
 * Entry point of the 'Documentation' generation module.
 *
 * @generated
 */
public class Documentation extends AbstractAcceleoGenerator {
    /**
     * The name of the module.
     *
     * @generated
     */
    public static final String MODULE_FILE_NAME = "/org/atlanmod/cypriot/generator/templates/documentation";
     ...
     * @generated
     */
    public Documentation(URI modelURI, File targetFolder,
     ...
     * @generated
     */
    public Documentation(EObject model, File targetFolder,
            List<? extends Object> arguments) throws IOException {
    ...
    public static void main(String[] args) {
        try {
            if (args.length < 2) {
                ...
                Documentation generator = new Documentation(modelURI, folder, arguments);
