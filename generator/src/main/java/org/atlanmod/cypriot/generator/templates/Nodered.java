...
/**
 * Entry point of the 'Nodered' generation module.
 *
 * @generated
 */
public class Nodered extends AbstractAcceleoGenerator {
    /**
     * The name of the module.
     *
     * @generated
     */
    public static final String MODULE_FILE_NAME = "/org/atlanmod/cypriot/generator/templates/nodered";
     ...
     * @generated
     */
    public Nodered(URI modelURI, File targetFolder,
     ...
     * @generated
     */
    public Nodered(EObject model, File targetFolder,
            List<? extends Object> arguments) throws IOException {
    ...
    public static void main(String[] args) {
        try {
            if (args.length < 2) {
                ...
                Nodered generator = new Nodered(modelURI, folder, arguments);
