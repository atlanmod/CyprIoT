...
uint8_t TemperaturePSM_sampling_var;
dht TemperaturePSM_dht_var;
uint8_t TemperaturePSM_pin_var;
...
#define TEMPERATUREPSM_TEMPERATURESENSORBEHAVIOR_SETUP_STATE 2
#define TEMPERATUREPSM_TEMPERATURESENSORBEHAVIOR_COLLECT_STATE 3
...
/*FORWARDERS*/// Forwarding of messages MQTT::TemperaturePIM::temperaturePort::temperatureMessage
void forward_MQTT_TemperaturePIM_send_temperaturePort_temperatureMessage(struct TemperaturePIM_Instance *_instance, uint32_t TemperatureData);
...
void MQTT_read() {
  ...
  MQTT_client.loop();
}// Forwarding of messages MQTT::TemperaturePIM::temperaturePort::temperatureMessage
void forward_MQTT_TemperaturePIM_send_temperaturePort_temperatureMessage(struct TemperaturePIM_Instance *_instance, uint32_t TemperatureData){
byte forward_buf[6];
...
void forward_TemperaturePIM_send_temperaturePort_temperatureMessage(struct TemperaturePIM_Instance *_instance, uint32_t TemperatureData){
if(_instance->id_temperaturePort == temppim_var.id_temperaturePort) {
forward_MQTT_TemperaturePIM_send_temperaturePort_temperatureMessage(_instance, TemperatureData);
}
}
...
register_external_TemperaturePIM_send_temperaturePort_temperatureMessage_listener(&forward_TemperaturePIM_send_temperaturePort_temperatureMessage);
