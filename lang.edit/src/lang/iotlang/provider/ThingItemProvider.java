...
/**
 * This is the item provider adapter for a {@link lang.iotlang.Thing} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ThingItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 IotlangPackage.Literals.THING__NAME,
				 true,
				 false,
				 false,
	...
	protected void addCodePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Thing_code_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Thing_code_feature", "_UI_Thing_type"),
				 IotlangPackage.Literals.THING__CODE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(IotlangPackage.Literals.THING__ANNOTATIONS);
			childrenFeatures.add(IotlangPackage.Literals.THING__PORTS);
		}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Thing.class)) {
			...
			case IotlangPackage.THING__CODE:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(IotlangPackage.Literals.THING__ANNOTATIONS,
				 IotlangFactory.eINSTANCE.createTargetAnnotation()));

		newChildDescriptors.add
			(createChildParameter
				(IotlangPackage.Literals.THING__PORTS,
				 IotlangFactory.eINSTANCE.createPort()));
	}
