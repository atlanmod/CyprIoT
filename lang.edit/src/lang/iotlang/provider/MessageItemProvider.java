...
/**
 * This is the item provider adapter for a {@link lang.iotlang.Message} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class MessageItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 IotlangPackage.Literals.MESSAGE__NAME,
				 true,
				 false,
				 false,
	...
	/**
	 * This adds a property descriptor for the Datatypes feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addDatatypesPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Message_datatypes_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Message_datatypes_feature", "_UI_Message_type"),
				 IotlangPackage.Literals.MESSAGE__DATATYPES,
				 true,
				 false,
				 true,
				 null,
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Message.class)) {
			case IotlangPackage.MESSAGE__NAME:
